...
public class DeliveredAdapter extends RecyclerView.Adapter<DeliveredAdapter.MyViewHolder> {
    ...
    public DeliveredAdapter(Context context, ArrayList<DeliveryItem> data) {
        this.dataSet = data;
    ...
    public DeliveredAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        DeliveredAdapter.MyViewHolder myViewHolder = new DeliveredAdapter.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(final DeliveredAdapter.MyViewHolder holder, final int listPosition) {
